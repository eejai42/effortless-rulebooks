...
A toy rulebook bootstrapped from the Turek–Hitchens debate material in `bootstrap/`. It implements a piece of the puzzle on purpose and is graded against the toy slot set.
