...
PROJECT_ROOT = PLATFORM_DIR.parent.parent  # repo root (legacy-runner lives under rulebook-examples/)
...
TRANSPILERS = {
    ...
    "rulebook-to-airtable": {
        "script": PLATFORM_DIR / "execution-substrates" / "airtable" / "inject-into-airtable.py",
