...
EXPERIENCE_DESCRIPTION='Authoritative philosophical language-classification rulebook'
START_COMMAND='./start.sh'
PORT=43101
PRIMARY_URL="http://localhost:${PORT}/is-everything-a-language-rulebook.json"
HEALTH_URL="$PRIMARY_URL"
SERVE_DIR="$PROJECT_ROOT/effortless-rulebook"
REQUIRED_FILE="$SERVE_DIR/is-everything-a-language-rulebook.json"
