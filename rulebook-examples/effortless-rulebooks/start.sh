...
PROJECT_NAME='effortless-rulebooks'
EXPERIENCE_DESCRIPTION='React and Express browser for the meta-rulebook Postgres views'
START_COMMAND='./start.sh'
API_PORT=3001
WEB_PORT=5173
PRIMARY_URL="http://localhost:${WEB_PORT}"
HEALTH_URL="http://localhost:${API_PORT}/api/tables"
export PGHOST="${PGHOST:-localhost}"
export PGUSER="${PGUSER:-postgres}"
export PGPORT="${PGPORT:-5432}"
export PGDATABASE="${PGDATABASE:-erb_effortless_rulesbooks}"
